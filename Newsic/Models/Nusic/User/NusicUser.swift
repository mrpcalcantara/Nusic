...
class NusicUser: Iterable {
    ...
    init(version: String? = Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as! String, userName: String, displayName: String? = "", imageURL: String? = "", territory: String? = "", favoriteGenres: [NusicGenre]? = nil, isPremium: Bool? = false, settingValues: NusicUserSettings? = NusicUserSettings()) {
