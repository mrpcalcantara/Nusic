...
//
//        currentSongCardFrame = self.frame
//
//    }
//
...
//
//        self.insertCardAtIndexRange(position..<position+1, animated: false);
//        self.delegate?.koloda(self, didShowCardAt: position)
//    }
//
//    func getCurrentCardView() -> SongOverlayView {
//        return self.viewForCard(at: self.currentCardIndex) as! SongOverlayView
//    }
//
...
//            DispatchQueue.main.async {
//                self.cardList.removeSubrange(self.self.currentCardIndex+1..<self.cardList.count)
//                self.addSongsToCardList(for: nil, tracks: tracks)
//                self.self.reloadCardsInIndexRange(self.self.currentCardIndex+1..<self.cardList.count)
//                SwiftSpinner.hide()
...
//}
//
//extension CardView: KolodaViewDelegate {
//
...
//
//
//extension CardView: KolodaViewDataSource {
//
